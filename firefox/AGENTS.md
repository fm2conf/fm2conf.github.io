# AGENTS.md — Firefox `user.js` Configurator

This is the agent instructions file used to generate the `firefox/` configurator in this repository.
...
```
Follow AGENTS.md. Create a configurator for Firefox. Here is more information: <firefox/prefs.js>.
```

The published artefact in this folder is the static `assets/` build output of the generated React + Vite project, plus the source `prefs.js` that was used as input.
